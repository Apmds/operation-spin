...
const NUM_LEVELS = 6
const LEVEL_SCENES: Dictionary[int, String] = {
...
func make_button(level: int, progress: Dictionary) -> Button:
	...
	var is_unlocked: bool = level == 1 or progress.get(level - 1, false)
...
func _build_level_buttons() -> void:
	...
	for level_number in range(1, NUM_LEVELS + 1):
		var button: Button = make_button(level_number, progress)
